...
class SupplierController extends Controller
{
  ...
  {
    return view('pages.supplier.superadmin.create');
  }
  ...
  public function store(Request $request)
  {
    ...
    try {
      ...
      return redirect()->route('superadmin.supplier.index')->with('success', 'Berhasil menambahkan data supplier.');
    } catch (\Exception $e) {
      return redirect()->route('superadmin.supplier.index')->with('error', 'Gagal menambahkan data supplier.');
    }
  }
  ...
  public function edit(int $id)
  {
    ...
    return view('pages.supplier.superadmin.edit', [
      'supplier' => $supplier
    ]);
  }
  ...
  public function update(Request $request, int $id)
  {
    ...
    return redirect()->route('superadmin.supplier.index')->with('success', 'Berhasil mengubah data supplier.');
  }
