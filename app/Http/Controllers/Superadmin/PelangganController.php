...
class PelangganController extends Controller
{
  ...
  public function create()
  {
    ...
    $kotas = Kota::all();
    $areas = Area::all();
    return view('pages.pelanggan.superadmin.create', [
  ...
  public function store(Request $request)
  {
    ...
    try {
      ...
      return redirect()->route('superadmin.pelanggan.index')->with('success', 'Berhasil menambahkan data pelanggan.');
    } catch (\Exception $e) {
      return redirect()->route('superadmin.pelanggan.index')->with('error', 'Gagal menambahkan data pelanggan.');
    }
  }
  ...
  public function edit(Pelanggan $pelanggan)
  {
    ...
    $kotas = Kota::all();
    $areas = Area::all();
    return view('pages.pelanggan.superadmin.edit', [
      'pelanggan' => $pelanggan,
      'tipePelanggans' => $tipePelanggans,
      'kotas' => $kotas,
      'areas' => $areas
  ...
  public function update(Request $request, int $id)
  {
    ...
    return redirect()->route('superadmin.pelanggan.index')->with('success', 'Berhasil mengubah data pelanggan.');
