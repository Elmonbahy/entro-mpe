...
class SampleOutController extends Controller
{
  ...
  {
    return view('pages.sample-out.fakturis.index');
  }
  ...
  {
    return view('pages.sample-out.fakturis.create', [
  ...
  public function edit(int $id)
  {
    ...
    return view('pages.sample-out.fakturis.edit', [
  ...
  public function update(Request $request, int $id)
  {
    ...
    try {
      ...
      return redirect()->route('fakturis.sample-out.index')->with('success', 'Berhasil mengubah data sampel keluar.');
    } catch (\Exception $e) {
      \DB::rollBack();
  ...
  public function store(Request $request)
  {
    ...
    try {
      ...
      return redirect()
        ->route('fakturis.sample-out.add-item', ['id' => $sample_out->id])
  ...
  public function show(int $id)
  {
    ...
    return view('pages.sample-out.fakturis.show', [
      'sample_out' => $sample_out,
  ...
  public function addItem(int $id)
  {
    ...
    return view('pages.sample-out.fakturis.add-item', compact('sample_out'));
  }
  ...
  public function exportSuratSample(int $id)
  {
    ...
    $pdf = Pdf::loadView('pages.surat-sample.fakturis.pdf', [
      'sample_out' => $sample_out,
  ...
  public function exportSpkb(int $id)
  {
    ...
    $pdf = Pdf::loadView('pages.spkb-sample.fakturis.pdf', [
      'sample_out' => $sample_out,
      'sample_out_detail' => $sample_out_detail,
      'waktu_cetak' => now()->setTimezone('Asia/Makassar')->format('d/m/Y H:i')
    ]);
