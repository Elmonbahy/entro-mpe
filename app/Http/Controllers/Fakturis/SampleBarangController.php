...
class SampleBarangController extends Controller
{
  ...
  {
    return view('pages.sample-barang.fakturis.index');
  }
  ...
  public function create()
  {
    ...
    return view('pages.sample-barang.fakturis.create', compact('barangs', 'satuans'));
  }
  ...
  public function store(Request $request)
  {
    ...
    try {
      ...
      return redirect()->route('fakturis.sample-barang.index')->with('success', 'Berhasil menambahkan data barang sampel.');
    } catch (\Throwable $th) {
      return redirect()->route('fakturis.sample-barang.index')->with('error', 'Gagal menambahkan data barang sampel.');
    }
  }
  ...
  public function show(SampleBarang $sample_barang)
  {
    $barang_stocks = BarangSampleStock::where('barang_id', $sample_barang->barang_id)
      ...
      ->get();
    return view('pages.sample-barang.fakturis.show', ['sample_barang' => $sample_barang, 'barang_stocks' => $barang_stocks]);
  }
  ...
  public function edit(SampleBarang $sample_barang)
  {
    ...
    return view('pages.sample-barang.fakturis.edit', [
  ...
  public function update(Request $request, int $id)
  {
    ...
    return redirect()->route('fakturis.sample-barang.index')->with('success', 'Berhasil mengubah data barang sampel.');
  }
