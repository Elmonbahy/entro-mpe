...
class SampleInController extends Controller
{
  ...
  {
    return view('pages.sample-in.fakturis.index');
  }
  ...
  {
    return view('pages.sample-in.fakturis.create', ['suppliers' => Supplier::select('id', 'nama')->get()]);
  }
  ...
  public function addItem(int $id)
  {
    ...
    return view('pages.sample-in.fakturis.add-item', compact('sample_in'));
  }
  ...
  public function show(int $id)
  {
    ...
    return view('pages.sample-in.fakturis.show', [
      'sample_in' => $sample_in,
  ...
  public function edit(int $id)
  {
    ...
    return view('pages.sample-in.fakturis.edit', ['suppliers' => Supplier::select('id', 'nama')->get(), 'sample_in' => $sample_in]);
  }
  ...
  public function store(Request $request)
  {
    ...
    try {
      ...
      return redirect()->route('fakturis.sample-in.add-item', ['id' => $sample_in->id])
        ->with('success', 'Berhasil menambahkan data sampel masuk.');
    } catch (\Exception $e) {
      return redirect()->route('fakturis.sample-in.index')
  ...
  public function update(Request $request, int $id)
  {
    ...
    try {
      ...
      return redirect()->route('fakturis.sample-in.index')->with('success', 'Berhasil mengubah data sampel masuk.');
    } catch (\Exception $e) {
      \DB::rollBack();
