...
class BarangController extends Controller
{
  ...
  public function create()
  {
    ...
    return view('pages.barang.supervisor.create', [
      'satuans' => $satuans,
      'suppliers' => $suppliers,
      'groups' => $groups,
      'brands' => $brands
  ...
  public function store(Request $request)
  {
    ...
    try {
      ...
      return redirect()->route('supervisor.barang.index')->with('success', 'Berhasil menambahkan data barang.');
    } catch (\Throwable $th) {
      return redirect()->route('supervisor.barang.index')->with('error', 'Gagal menambahkan data barang.');
    }
  }
  ...
  public function edit(Barang $barang)
  {
    ...
    return view('pages.barang.supervisor.edit', [
      'barang' => $barang,
      'satuans' => $satuans,
      'suppliers' => $suppliers,
      'groups' => $groups,
  ...
  public function update(Request $request, int $id)
  {
    ...
    return redirect()->route('supervisor.barang.index')->with('success', 'Berhasil mengubah data barang.');
  }
