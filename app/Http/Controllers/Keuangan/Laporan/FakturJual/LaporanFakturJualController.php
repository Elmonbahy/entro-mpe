...
class LaporanFakturJualController extends Controller
{
  ...
  public function index(Request $request)
  {
    ...
    return view('pages.laporan-jual-faktur.keuangan.index', [
  ...
  public function exportExcel(Request $request)
  {
    ...
    $filename = "Laporan_Faktur_Jual_all $tgl_awal - $tgl_akhir.xlsx";

    if ($request->pelanggan_id) {
      $filename = "laporan_faktu_jual_pelanggan $tgl_awal - $tgl_akhir.xlsx";
    }

    if ($request->sales_id) {
      $filename = "laporan_laktur_jual_sales $tgl_awal - $tgl_akhir.xlsx";
    }
