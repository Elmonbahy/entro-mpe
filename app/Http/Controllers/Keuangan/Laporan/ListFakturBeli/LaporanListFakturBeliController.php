...
class LaporanListFakturBeliController extends Controller
{
  ...
  public function index(Request $request)
  {
    ...
    return view('pages.laporan-list-faktur-beli.keuangan.index', [
      'suppliers' => $suppliers,
  ...
  public function exportExcel(Request $request)
  {
    ...
    return Excel::download(
      new LaporanListFakturBeliExport($data, $request->tgl_awal, $request->tgl_akhir, $request->filter_berdasarkan ?? 'tgl_faktur'),
      $filename
    );
  }
