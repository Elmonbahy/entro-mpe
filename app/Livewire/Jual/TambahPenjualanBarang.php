...
class TambahPenjualanBarang extends Component
{
  ...
  private function setBarangStock(int $barang_id)
  {
    ...
    // Ambil data stok yang tersedia (FEFO)
  ...
  {
    $this->reset(['barang_id', 'brand_id', 'satuan', 'harga_beli_formatted', 'batch', 'tgl_expired', 'tgl_expired_formatter', 'stock', 'stock_all', 'keterangan', 'jumlah_barang_dipesan', 'harga_jual']);
  }
