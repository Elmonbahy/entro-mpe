<div>
  <form action="{{ route('accounting.mutation.kartu-stock') }}" method="GET" autocomplete="off">

    <div class="row">
      <div class="col-md-4 mb-3" wire:ignore>
        <x-form.label value="Brand" />
        <x-form.select name="brand_id" placeholder="Cari atau pilih barang" :options="$brands" valueKey="id" labelKey="nama"
          :selected="$brand_id" />
      </div>

      <div class="col-md-4 mb-3" wire:ignore>
        <x-form.label value="Barang" />
        <x-form.select name="barang_id" placeholder="Cari atau pilih brand" :options="$barangs" valueKey="id"
