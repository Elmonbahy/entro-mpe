<div class="card">
  <div class="card-header p-3 d-flex justify-content-between align-items-center">
    <p class="mb-0 fw-semibold">Daftar sample barang</p>

    @if ($sample_out->status_sample === \App\Enums\StatusSample::PROCESS_SAMPLE)
      <button class="btn btn-primary" wire:click="sendToGudang()"
        wire:confirm="Sampel keluar akan dikirim untuk diproses oleh gudang?">
        Selesai
      </button>
    @endif
  </div>
              ...
              <tr wire:key="{{ $item->id }}">
                ...
                <td>
                  <button class="btn btn-danger mb-1" wire:click="delete({{ $item->id }})"
                    wire:confirm="Hapus barang dari daftar sampel keluar?">
