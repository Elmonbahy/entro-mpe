<div class="card border-0 shadow-sm mt-4">
  <div class="card-header bg-white py-3">
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3">
      <div>
        <h5 class="mb-0 fw-bold text-dark">Rekap Faktur Beli Bulanan</h5>
...
@push('scripts')
  <script>
    ...
    // Jalankan setelah Livewire selesai melakukan update DOM
    document.addEventListener('livewire:navigated', animateBars); // Untuk Livewire v3
