  ...
  <div class="container-fluid px-4">
    <x-page-header title="Sampel Keluar" class="mb-3">
      <div class="dropdown">
        ...
        <ul class="dropdown-menu">
          <li>
            <a class="dropdown-item" href="{{ route('fakturis.sample-out.surat-sample', ['id' => $sample_out->id]) }}"
              target="_blank">
              <i class="bi bi-file-earmark-arrow-down"></i> Surat
            </a>
          </li>
          <li>
            <a class="dropdown-item" href="{{ route('fakturis.sample-out.spkb', ['id' => $sample_out->id]) }}"
              target="_blank">
    ...
    <div class="card mt-3">
      <div class="card-header p-3 d-flex justify-content-between align-items-center">
        ...
        <a class="btn btn-primary" href="{{ route('fakturis.sample-out.add-item', ['id' => $sample_out->id]) }}">
          Sesuaikan
        </a>
