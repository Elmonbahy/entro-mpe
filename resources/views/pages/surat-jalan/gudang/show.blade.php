...
@section('content')
  <div class="container-fluid px-4">
    <x-page-header title="Surat Jalan" class="mb-3">
      <a href="{{ route('gudang.surat-jalan.pdf', ['id' => $surat_jalan->id]) }}" class="btn btn-primary" target="_blank">
    ...
    <div class="card mt-3">
      <div class="card-header p-3 d-flex justify-content-between align-items-center">
        ...
        @can('update', $surat_jalan)
          <a class="btn btn-primary" href="{{ route('gudang.surat-jalan.add-item', ['id' => $surat_jalan->id]) }}">
            Sesuaikan
          </a>
        @endcan
      </div>
