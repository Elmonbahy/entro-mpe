...
@section('content')
  <div class="p-4">
    ...
    {{-- @foreach ($jual->jualDetails as $item) --}}
    <table style="font-family: sans-serif; font-size: 13px; width: 100%;" class="mt-1">
      <tr>
        ...
        <td style="border-bottom: 1px dotted #000;">
          <strong>{{ $jual_detail->barang->nama ?? '' }}</strong>
        </td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td>:</td>
        <td style="border-bottom: 1px dotted #000;">
          <strong>{{ $jual_detail->batch ?? '' }}</strong>
        </td>
      </tr>
      <tr>
        ...
        <td style="border-bottom: 1px dotted #000;">
          <strong>
            {{ $jual_detail->tgl_expired ? \Carbon\Carbon::parse($jual_detail->tgl_expired)->format('d/m/Y') : '' }}</strong>
        </td>
      </tr>
    </table>
