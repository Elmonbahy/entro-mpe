...
@section('content')
  <div class="p-4">
    ...
    <div class="text-start pb-1 mt-2">
      <p class="fw-bold mb-0" style="font-size: 15px;">DO MASUK</p>
      <p class="text-end">No:
        {{ $beli->nomor_faktur }}
      </p>
    </div>
        ...
        @foreach ($beli_detail as $item)
          <tr>
            ...
            <td width="20" class="text-center">
              {{ number_format($item->jumlah_barang_masuk, 0, ',', '.') }}</td>
          </tr>
        @endforeach
      </tbody>
    </table>
    ...
    <table style="width: 100%; border-collapse: collapse; margin-top: 15px;">
      <tr>
        ...
        <td style="width: 50%; vertical-align: top;">
          <table style="width: 100%; border-collapse: collapse;">
            <tr>
              <td style="width: 50%; border: 1px solid black; text-align: center;"><strong>Purchasing</strong></td>
    ...
    <p class="text-end mt-1" style="font-size: 10px">F.APM/WH-001 R.00/301123</p>
  </div>
@endsection
