...
@section('content')
  @foreach ($beli_details as $beli_detail)
    <div class="p-4">
      <!-- Header -->
      <div
      ...
      <div class="text-center pb-1 mt-2">
        ...
        <p class="text-center">No: {{ $beli->nomor_faktur }}</p>
      </div>
      ...
      <table style="font-family: sans-serif; font-size: 13px; width: 100%;" class="mt-1">
        <tr>
          ...
          <td style="border-bottom: 1px dotted #000;"><strong>{{ $beli_detail->barang->nama ?? '' }}</strong></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td>:</td>
          <td style="border-bottom: 1px dotted #000;"><strong>{{ $beli_detail->batch ?? '' }}</strong></td>
        </tr>
        <tr>
          <td><strong>Expired Date </strong><sup>*)</sup></td>
          <td>:</td>
          <td style="border-bottom: 1px dotted #000;">
            <strong>{{ $beli_detail->tgl_expired ? \Carbon\Carbon::parse($beli_detail->tgl_expired)->format('d/m/Y') : '' }}</strong>
          </td>
        </tr>
      </table>
