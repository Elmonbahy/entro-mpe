...
@section('content')
  <div class="container-fluid px-4">
    ...
    <x-page-header title="Laporan Pending" class="mb-3">
    </x-page-header>

    <div class="card mb-3">
      <div class="p-3 card-header d-flex align-items-center">
        <p class="mb-0 fw-semibold me-2">Form Laporan Barang Pending</p>
        <x-info-tooltip
...
• Jika memilih pelanggan, rentang bisa lebih 1 bulan." />
      ...
      <div class="p-3">
        <form method="GET" action="{{ route('gudang.laporan-pending.index') }}" autocomplete="off">
          <div class="row">
    ...
    @if ($data->isEmpty())
      <div class="card">
        <div class="p-3 card-header">
          <p class="mb-0 fw-semibold">Tabel Laporan Barang Pending</p>
        </div>
        <div class="card-body">
    ...
    @if ($data->isNotEmpty())
      <div class="card">
        <div class="p-3 card-header d-flex justify-content-between align-items-center">
          <p class="mb-0 fw-semibold">Tabel Laporan Barang Pending</p>
          <a href="{{ route('gudang.laporan-pending.excel') }}?tgl_awal={{ $tgl_awal }}&tgl_akhir={{ $tgl_akhir }}&pelanggan_id={{ $pelanggan_id }}"
