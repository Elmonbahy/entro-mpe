...
• Status bayar opsional: Lunas / Belum Lunas." />
      ...
      <div class="p-3">
        <form method="GET" action="{{ route('accounting.laporan-list-faktur-beli.index') }}" autocomplete="off">
          <div class="row">
    ...
    @if ($data->isNotEmpty())
      <div class="card">
        <div class="p-3 card-header d-flex justify-content-between align-items-center">
          ...
          <a href="{{ route('accounting.laporan-list-faktur-beli.excel') }}?tgl_awal={{ request('tgl_awal') }}&tgl_akhir={{ request('tgl_akhir') }}&supplier_id={{ request('supplier_id') }}&status_bayar={{ request('status_bayar') }}"
