  ...
  <div class="container-fluid px-4">
    ...
    <div class="card mb-3">
      <div class="p-3 card-header d-flex align-items-center">
        <p class="mb-0 fw-semibold">Form Laporan Faktur Jual</p>
        <x-info-tooltip
...
• Sales dan Status bayar opsional." />
      ...
      <div class="p-3">
        <form method="GET" action="{{ route('accounting.laporan-jual-faktur.index') }}" autocomplete="off">
          <div class="row">
    ...
    @if ($data->isNotEmpty())
      <div class="card">
        <div class="p-3 card-header d-flex justify-content-between align-items-center">
          <p class="mb-0 fw-semibold">Tabel Laporan Faktur Jual</p>
          <a href="{{ route('accounting.laporan-jual-faktur.excel') }}?tgl_awal={{ $tgl_awal }}&tgl_akhir={{ $tgl_akhir }}&pelanggan_id={{ $pelanggan_id }}&sales_id={{ $sales_id }}&status_bayar={{ request('status_bayar') }}"
